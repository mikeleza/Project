    ...
    <div class="container">
      <div class="row">
        <div class="col-12 col-sm-12 mt-3">
          <div class="alert alert-light" role="alert">
           <p class="fs-1 text-dark" align="center">กระดานสนทนา เทคนิคพิเศษ</p> 
          </div>
        </div>
      </div>
      ...
      <div class="card">
        ...
        <div class="btn-group" style="width: 5rem;">
          <a href="webboard/ques_board.php?x=board_tech&cate=1" class="btn btn-info">ตั้งกระทู้</a>
        </div>
        </div>
        </div>
        ...
        <div class="col-12 col-sm-12 mt-2">
          ...
          <ul class="pagination justify-content-center">
            <li <?php if($page == 1) {echo 'class="page-item disabled"';}
              ...
              <a class="page-link" href="blog.php?x=board_tech&cate=1&page=<?php echo $page-1; ?>" aria-label="Previous">
                <span aria-hidden="true">&laquo;</span>
              </a>
            </li>
            <?php for($i=1;$i<=$total_page;$i++){ ?>
            <li <?php if($page == $i) echo 'class="page-item active"' ;?>><a class="page-link" href="blog.php?x=board_tech&cate=1&page=<?php echo($i); ?>"><?php echo $i;?></a></li>
              <?php } ?>

            <li <?php if($page >= $total_page) {echo 'class="page-item disabled"';}
                  else echo 'class="page-item"';?>>
              <a class="page-link" href="blog.php?x=board_tech&cate=1&page=<?php echo $page+1; ?>" aria-label="Next">
